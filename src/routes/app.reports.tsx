...
function Reports() {
  ...
  const exportCSV = () => {
    ...
    a.href = url;
    a.download = `pulse-inv-${from}-to-${to}.csv`;
    a.click();
  };
    ...
    autoTable(doc, {
      ...
      body: rows.map((r) => {
        ...
        return [
          ...
          p?.department ?? "—",
          r.reason,
          fmtDateTime(r.out_time),
          fmtDateTime(r.in_time),
          r.duration_minutes ?? "—",
          deviceByUser[r.user_id] ?? "—",
        ];
      }),
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="glass">
          <CardHeader>
            <CardTitle>Time by reason</CardTitle>
          </CardHeader>
        ...
        <Card className="glass">
          <CardHeader>
            <CardTitle>Top staff (minutes out)</CardTitle>
          </CardHeader>
          <CardContent style={{ height: 280 }}>
            <ResponsiveContainer>
