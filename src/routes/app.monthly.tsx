...
// Low = ideal (<= 100 min/day), Medium = watch, High = needs attention.
const LOW_MAX = 100;   // <= 100 min / day
const MED_MAX = 130;  // <= 130 min / day
      ...
      <div className="flex flex-col md:flex-row md:items-end gap-4 justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Activity categorised by average break time per day. Low = ideal (≤ 100 min/day), Medium = 101–130, High &gt; 131 min/day.
          </p>
        </div>
